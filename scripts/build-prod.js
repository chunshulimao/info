...
const PROD_BUILD_PATH = path.resolve(paths.appPath, 'build', 'prod')
paths.appBuild = PROD_BUILD_PATH
...
function build(previousFileSizes) {
  ...
  console.log(`Creating an optimized production build in ${paths.appBuild}...`)
